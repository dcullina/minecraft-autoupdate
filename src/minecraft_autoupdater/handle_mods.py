...
def get_latest_mod_versions(mods: dict) -> str:
    ...
    for mod in mods["mods"]:
        url = f"https://www.curseforge.com/api/v1/mods/{mod["projectId"]}/files?pageIndex=0&pageSize=1&sort=dateCreated&sortDescending=true&gameVersionId={mods["curseForgeDetails"]["gameVersionId"]}&gameFlavorId={mods["curseForgeDetails"]["gameFlavorId"]}&removeAlphas=false"
